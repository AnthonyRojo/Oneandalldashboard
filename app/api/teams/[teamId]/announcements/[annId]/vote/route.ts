...
// POST /api/teams/[teamId]/announcements/[annId]/vote
export async function POST(
  ...
  try {
    ...
    const pollVotes: Record<string, string> = existing.poll_votes || {};
    pollVotes[user.id] = optionId;
    ...
    return serverError("Failed to vote on poll");
  }
}
